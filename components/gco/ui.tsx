...
import { AlertCircle, ArrowLeft, Check, ChevronRight, X, type LucideIcon } from "lucide-react"
...
export function PageHeader({
  ...
  return (
    <div className="flex flex-col xl:flex-row xl:items-end xl:justify-between gap-4 mb-5">
      <div>
        {!hideBack && (
          <button type="button" onClick={() => router.back()} className="fx inline-flex items-center gap-1.5 text-xs font-semibold mb-2" style={{ color: "var(--gco-text-2)" }}>
